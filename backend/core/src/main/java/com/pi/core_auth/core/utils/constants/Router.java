...
public class Router {
     ...
     */
    public static final String ROUTER_AUTH_INFO = "/auth/info";

    /**
     * The route for getStatusToken.
     * This route points to the "/auth/v1/get/status/token" endpoint.
     */
    public static final String ROUTER_GET_STATUS_TOKEN = "/auth/v1/get/status/token";

    /**
     * The route for getScopeToken.
     * This route points to the "/auth/v1/get/scope/token" endpoint.
     */
    public static final String ROUTER_GET_SCOPE_TOKEN = "/auth/v1/get/scope/token";

    /**
     * The route for postSignInToken.
     * This route points to the "/auth/v1/post/sign/in/token" endpoint.
     */
    public static final String ROUTER_POST_SIGN_IN_TOKEN = "/auth/v1/post/sign/in/token";

    /**
     * The route for postAnonymousToken.
     * This route points to the "/auth/v1/post/anonymous/token" endpoint.
     */
    public static final String ROUTER_POST_ANONYMOUS_TOKEN = "/auth/v1/post/anonymous/token";
}
