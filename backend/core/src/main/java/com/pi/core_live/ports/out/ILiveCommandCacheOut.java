...
/**
 * This interface represents the output port cache for the live service, which is
 ...
 * @since   1.0.0
 */
public interface ILiveCommandCacheOut {

    /**
     * Creates a new live class.
     *
     * @param teacherToken The token of the teacher.
     ...
     */
    Mono<Live> createLive(final String teacherToken,final String loginTeacher, final String codeTeacher, final String keyQuiz) throws GlobalException;
     ...
     * @throws GlobalException if an error occurs during the process.
     */
    Mono<Live> nextPosition(final String keyLive) throws GlobalException;
     ...
     * @throws GlobalException if an error occurs during the process.
     */
    Mono<Live> previousPosition(final String keyLive) throws GlobalException;
     ...
     * @throws GlobalException if an error occurs during the process.
     */
    Mono<Live> removePupilFromLobby(final String loginPupil, final String codePupil, final String keyLive) throws GlobalException;
     ...
     * Ends the live class.
     *
     * @param tokenTeacher The token of the teacher.
     * @param loginTeacher The login of the teacher.
     * @param codeTeacher The code of the teacher.
     * @param keyLive The key of the live class.
     * @return A Mono that emits the updated live class.
     * @throws GlobalException if an error occurs during the process.
     */
    Mono<Live> endLive(final String tokenTeacher, final String loginTeacher, final String codeTeacher, final String keyLive) throws GlobalException;
}
