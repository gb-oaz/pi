...
@Service
public class CaseEndLiveMono implements Callable<Mono<Live>>, ITokenCheck {
    ...
    /**
     * Sets the ILiveCommandCacheOut that will be used to end a live.
     *
     * @param liveCommandOut ILiveCommandCacheOut that will be used to end a live.
     */
    ...
    /**
     * Sets the CommandDto that will be used to end a live.
     *
     * @param dto the CommandDto to use for ending a live.
    ...
    /**
     * Executes the use case to end a live.
     *
    ...
    public Mono<Live> call() throws GlobalException {
        ...
        var response = liveCommandOut.endLive(dto.token(), dto.login(), dto.code(), dto.keyLive());
